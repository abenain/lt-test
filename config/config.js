...
const USER_REPORT_PERIOD_MS = 30 * 1000;	//How often shall each user/participant report positions?
const NB_CONCURRENT_POS_REPORT = 6;		//How many positions shall be reported at every iteration?
